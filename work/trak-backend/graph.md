...
- state: decided (2026-06-13) — option 2 (operator, commit b49ef49): clone + build plexus-idp as the OIDC issuer at :4461. Execution — move the workspace to the UT-wave3/UT-1 version set, rebuild trak on feature/UT-wave3-oidc-cutover with --oidc-issuer, mint a plexus:trak RS256 token, confirm a write — is the standup node above; this node clears when that write round-trips.
- since: 2026-06-13
- of: switch hypercore's document backend to trak
