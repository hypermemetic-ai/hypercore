...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 Merged worktrees and branches are removed behind TASK-49's rails
...
deciq worktree/branch backlog cleared: 12 merged worktrees and 31 merged branches removed behind TASK-49/doc-44 rails; nothing forced. Disposition of feat/task-22-logic-promotion recorded: left intact — unmerged, unpushed only-copy (tip 3c963e6, 2026-07-15, no origin branch); recommend a TASK-52-style push-or-decline decision; its continuation lives in the deciq-logic repository.
