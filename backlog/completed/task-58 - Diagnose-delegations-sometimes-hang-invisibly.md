...
Root causes identified with evidence (doc-45): codex startup wedge (the hang) x dispatched-forever glass + pre-TASK-45 invisibility (the invisible). Bounded fixes proposed for operator disposition; none applied to skill text without approval.
