...
A new kind enters in the same edit as the statement that must find it, and stays only while a statement reads it; other new words are names for clusters. [machine]
