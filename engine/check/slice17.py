"""Slice 17 — the external-conformance gate: the channels match the field standard and resolve.
...
def check(_shared_root: str) -> None:
    ...
    print("\nslice 17 — acceptance check  (the external-conformance gate: the channels conform and resolve)\n")

    root = tempfile.mkdtemp(prefix="engine-check-slice17-")
