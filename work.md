...
- state: decided (2026-06-13) — option 1 — push now — publish the file-based, portable hypercore to origin/main, trak.py dormant alongside it; `git push -u origin main` (local main has no upstream and is ~188 commits ahead of the last-known origin/main)
- since: 2026-06-13
