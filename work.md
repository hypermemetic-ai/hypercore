...
- options: document moves to the work view — d on a selected project line opens that unit's documents, and the queue loses d . d reads where you stand — the queue's d keeps opening intent.md, and the work view gains d on the selected project line for that unit's documents . the selected work unit becomes standing state — set in the work view, named in the header everywhere, d on the queue opens its documents
